...
import org.firewall.protectify.util.Rule;
import org.firewall.protectify.widget.ClickPreference;
...
public class RuleConfigFragment extends ConfigFragment {
        ...
        if (requestCode == READ_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
            if (resultData != null) {
                ...
                try {
                    ...
                    String file = System.currentTimeMillis() + ".dr";
    ...
    private static class RuleConfigHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == MSG_RULE_DOWNLOADED) {
