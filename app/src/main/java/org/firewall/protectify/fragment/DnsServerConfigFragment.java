...
import org.firewall.protectify.activity.ConfigActivity;
import org.firewall.protectify.server.CustomDnsServer;
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        if (id == R.id.action_apply) {
            ...
            if (serverName.equals("") || serverAddress.equals("") || serverPort.equals("")) {
                ...
                if (index == ConfigActivity.ID_NONE) {
                    Daedalus.configurations.getCustomDNSServers()
                            .add(new CustomDnsServer(serverName, serverAddress, Integer.parseInt(serverPort)));
                } else {
                    CustomDnsServer server = Daedalus.configurations.getCustomDNSServers().get(index);
